DELETE FROM `trabalho1-pdm-2026.silver._transformation_log` WHERE TRUE;

INSERT INTO `trabalho1-pdm-2026.silver._transformation_log`
...
FROM `trabalho1-pdm-2026.silver.tx_origin_index`;
...
FROM `trabalho1-pdm-2026.silver.network_context_hourly`
